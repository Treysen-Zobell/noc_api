...
@router.get(
    "/node/{node_id}/ont/{ont_id}/port/{port_type}/{port_nr}",
    summary="Get all information for a port on an ont",
    description="Feature not implemented",
)
def get_ont_port(
    request: Request, node_id: str, ont_id: int, port_type: str, port_nr: int
):
    pass


@router.get(
    "/node/{node_id}/ont/{ont_id}/port/{port_type}/{port_nr}/location",
...
@router.get(
    "/node/{node_id}/ont/{ont_id}/port/{port_type}/{port_nr}/status",
